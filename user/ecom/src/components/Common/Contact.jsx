                            ...
                            <Row className="text-center">
                                <Col className="d-flex justify-content-center" md={6} lg={6} sm={12} xs={12}>
                                    <Form id="contactForm" onSubmit={this.onFormSubmit} className="onboardForm">
                                        ...
                                        <input onChange={this.nameOnChange} value={this.state.name} className="form-control m-2" type="text" placeholder="Enter Your Name" />
                                        <input onChange={this.emailOnChange} value={this.state.email} className="form-control m-2" type="email" placeholder="Enter Email" />
                                        <Form.Control onChange={this.messageOnChange} value={this.state.message} className="form-control m-2" as="textarea" rows={3} placeholder="Message" />
